...
show.expected=T,heading="Random Forests", height=2.5, col0="white", col1="black")
...
write.csv(predictions, file="testing_file_CW_onset_RF_rep_final_replicated.csv")
